...
export const myCustomTheme: CustomThemeConfig = {
	...
	properties: {
		...
		'--color-error-300': '254 191 191',
		'--color-error-400': '253 143 143',
		'--color-error-500': '252 95 95',
		'--color-error-600': '227 86 86',
		'--color-error-700': '189 71 71',
		'--color-error-800': '151 57 57',
